...
export const PROFILE = {
  ...
  AVATAR:
    'https://scontent.fsgn5-2.fna.fbcdn.net/v/t1.0-9/51785928_797123840648261_8561007407440855040_n.jpg?_nc_cat=105&_nc_oc=AQlSo6EFrOXLsLu0TFW9xu6Gk0jjAwmzhGOv9pZqImBr_6XezH_b1q6pCpI_MaKqOy4&_nc_ht=scontent.fsgn5-2.fna&oh=4726f7e000aeda0c2e018495ec7e42ff&oe=5D1A650C', // eslint-disable-line max-len
  ...
  DETAIL: {
    ...
    EXPERIENCE: {
      'Front-end':
        'I have experience **HTML5**, **CSS3** and **Javascript**. I have knowledge about **React**, **jQuery** and other libraries. I am creator of [ciser](https://www.npmjs.com/package/ciser) and [liser](https://www.npmjs.com/package/liser), css functional support all responsive queries. In addition, I am contributor to some [React packages](https://www.npmjs.com/~lamhieu) such as [react-resize-detector](https://www.npmjs.com/package/react-resize-detector), [rc-image-loader](https://www.npmjs.com/package/rc-image-loader) and more. Please view [my Github](https://github.com/lamhieu-vk) to see more information.', // eslint-disable-line max-len
      'Back-end':

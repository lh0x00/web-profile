...
export const PROFILE = {
  ...
  DETAIL: {
    ...
    SKILL: {
      ...
      'Unit test': 'I familiar to implementing **unit testing** for **React** and **NodeJS** applications. **Jest**, **Enzyme** and **Sinon** are my favorite tools for this. At **Sendo**, I developed a new **test runner** based on some libraries, which is a combination and customized for the business., **Enzyme** and **Sinon** are my favorite tools for this. At **Sendo**, I developed a new **test runner** based on some libraries, which is a combination and customized for the business.', // eslint-disable-line max-len
      'Business websites':
